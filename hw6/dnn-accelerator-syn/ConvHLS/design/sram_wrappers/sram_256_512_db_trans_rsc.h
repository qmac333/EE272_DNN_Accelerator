#ifndef __INCLUDED_sram_256_512_db_trans_rsc_H__
#define __INCLUDED_sram_256_512_db_trans_rsc_H__
#include <mc_transactors.h>

class sram_256_512_db_trans_rsc : public mc_wire_trans_rsc_base<512,256>
{
public:
  sc_in< bool >   clk0;
  sc_in< sc_logic >   csb0;
  sc_in< sc_logic >   web0;
  sc_in< sc_lv<8> >   addr0;
  sc_in< sc_lv<512> >   din0;
  sc_in< bool >   clk1;
  sc_in< sc_logic >   csb1;
  sc_in< sc_lv<8> >   addr1;
  sc_out< sc_lv<512> >   dout1;

  typedef mc_wire_trans_rsc_base<512,256> base;
  MC_EXPOSE_NAMES_OF_BASE(base);

  SC_HAS_PROCESS( sram_256_512_db_trans_rsc );
  sram_256_512_db_trans_rsc(const sc_module_name& name, bool phase, double clk_skew_delay=0.0)
  ...
  virtual void start_of_simulation() {
    ...
    if (base::_holdtime > 0) {
      ...
      msg << "sram_256_512_db_trans_rsc CLASS_STARTUP - CLK_SKEW_DELAY = "
...
private:
  ...
  void clk_skew_delay() {
    ...
    if ( _is_connected_port_0 && (_csb0==0) && (_csb1==0) && (_web0==0)) {
      ...
      if (_w_addr_port_0 >= 0)
        inject_value(_w_addr_port_0, 0, 512, _din0, 0);
    }
    ...
    if ((_csb0==0) && (_csb1==0)) {
      ...
      if (addr >= 0)
      {
        if (addr==_w_addr_port_0) {
          ...
          extract_value(addr, 0, 512, _dout1, 0);
      }
      else { 
        sc_lv<512> dc; // X
        _dout1 = dc;
...
#endif // ifndef __INCLUDED_sram_256_512_db_trans_rsc_H__
