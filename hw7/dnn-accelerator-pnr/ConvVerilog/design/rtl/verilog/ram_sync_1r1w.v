  ...
  */
  ...
  generate
    if (DEPTH >= 1024) begin
      ...
      for (x = 0; x < DATA_WIDTH/32; x = x + 1) begin: width_macro
        // note: In our testbench, the clock period is 6ns
        //       but by default, this behavior model reads
        //       out the data 3ns after the negative edge.
        //       We manually changed the default delay to
        //       be 1ns to prevent potential racing error.
