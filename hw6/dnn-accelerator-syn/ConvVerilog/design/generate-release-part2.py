...
# C files
copyfile('cpp/conv_gold.cpp', '../dnn-accelerator-top-rtl/cpp/conv_gold.cpp')
copyfile('cpp/conv_gold_tiled.cpp', '../dnn-accelerator-top-rtl/cpp/conv_gold_tiled.cpp')
...
# copyfile('cpp/mac_gold.cpp', '../dnn-accelerator-top-rtl/cpp/mac_gold.cpp')
...
copyfile('verilog/mac.v', '../dnn-accelerator-top-rtl/verilog/mac.v')
copyfile('verilog/systolic_array.v', '../dnn-accelerator-top-rtl/verilog/systolic_array.v')
copyfile('verilog/double_buffer.v', '../dnn-accelerator-top-rtl/verilog/double_buffer.v')
copyfile('verilog/accumulation_buffer.v', '../dnn-accelerator-top-rtl/verilog/accumulation_buffer.v')
copyfile('verilog/adr_gen_sequential.v', '../dnn-accelerator-top-rtl/verilog/adr_gen_sequential.v')
copyfile('verilog/ifmap_radr_gen.v', '../dnn-accelerator-top-rtl/verilog/ifmap_radr_gen.v')
...
copyfile('tests/fifo_tb.v', '../dnn-accelerator-top-rtl/tests/fifo_tb.v')
copyfile('tests/double_buffer_tb.v', '../dnn-accelerator-top-rtl/tests/double_buffer_tb.v')
copyfile('tests/weight_double_buffer_tb.v', '../dnn-accelerator-unit-rtl/tests/weight_double_buffer_tb.v')
copyfile('tests/ifmap_double_buffer_tb.v', '../dnn-accelerator-unit-rtl/tests/ifmap_double_buffer_tb.v')
copyfile('tests/accumulation_buffer_tb.v', '../dnn-accelerator-top-rtl/tests/accumulation_buffer_tb.v')
copyfile('tests/adr_gen_sequential_tb_uvm.v', '../dnn-accelerator-top-rtl/tests/adr_gen_sequential_tb_uvm.v')
copyfile('tests/mac_tb_uvm.v', '../dnn-accelerator-top-rtl/tests/mac_tb_uvm.v')
