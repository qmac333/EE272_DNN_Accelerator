...
FILES {
  { FILENAME /home/users/jiajunc4/ee272/git_ee272/EE272_DNN_Accelerator/hw6/dnn-accelerator-syn/ConvHLS/design/sram_wrappers/sram_256_512_db.v FILETYPE Verilog MODELTYPE generic PARSE 1 PATHTYPE copy STATICFILE 1 VHDL_LIB_MAPS work }
}
VHDLARRAYPATH    {}
WRITEDELAY       0.1
INITDELAY        1
...
PINMAPS {
  ...
  { PHYPIN din0  LOGPIN DATA_IN      DIRECTION in  WIDTH 512.0 PHASE {} DEFAULT {} PORTS port_0 }
  ...
  { PHYPIN dout1 LOGPIN DATA_OUT     DIRECTION out WIDTH 512.0 PHASE {} DEFAULT {} PORTS port_1 }
}
