#ifndef __INCLUDED_sram_256_32_1w1r_trans_rsc_H__
#define __INCLUDED_sram_256_32_1w1r_trans_rsc_H__
#include <mc_transactors.h>

class sram_256_32_1w1r_trans_rsc : public mc_wire_trans_rsc_base<32,256>
{
public:
  sc_in< bool >   clk0;
  sc_in< sc_logic >   csb0;
  ...
  SC_HAS_PROCESS( sram_256_32_1w1r_trans_rsc );
  sram_256_32_1w1r_trans_rsc(const sc_module_name& name, bool phase, double clk_skew_delay=0.0)
  ...
  virtual void start_of_simulation() {
    ...
    if (base::_holdtime > 0) {
      ...
      msg << "sram_256_32_1w1r_trans_rsc CLASS_STARTUP - CLK_SKEW_DELAY = "
...
#endif // ifndef __INCLUDED_sram_256_32_1w1r_trans_rsc_H__
