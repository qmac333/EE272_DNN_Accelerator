#ifndef __INCLUDED_sram_256_512_db_H__
#define __INCLUDED_sram_256_512_db_H__

// SystemC memory model of sram_256_512_db
...
//     class sram_256_512_db a 0 delay "structural" model of the RAM

//     class sram_256_512_db_model<TLM/SYN>::mem<T,size,TLM/SYN>
//         A memory model that can be instanced and used for simulation and synthesis

//     class sram_256_512_db_model<TLM/SYN>::port_0_port<T,size,TLM/SYN>
//         a model of an external port with write capability

//     class sram_256_512_db_model<TLM/SYN>::port_1_port<T,size,TLM/SYN>
...
#pragma map_to_operator sram_256_512_db
template <
  int ram_id>
class sram_256_512_db : public sc_module
{
public:
  sc_in< bool >   clk0;
  sc_in< bool >   csb0;
  ...
  sc_signal<sc_lv<512> > mem[256];
#endif

  SC_CTOR(sram_256_512_db) :
    clk0("clk0")
    ,csb0("csb0")
    ,web0("web0")
    ,addr0("addr0")
  ...
  sc_lv< 512> tb_read( int address ) const {
#ifndef NO_ASSERTS
    assert( address>=0 && address < 256);
#endif
    return mem[address];
  ...
  // NOTE: this method is intended for use by testbenches only. It is not synthesizable!
  void tb_write( int address, sc_lv<512> data ) {
#ifndef NO_ASSERTS
    assert( address>=0 && address < 256);
#endif
    mem[address] = data;
...
#endif // ifndef __INCLUDED_sram_256_512_db_H__
