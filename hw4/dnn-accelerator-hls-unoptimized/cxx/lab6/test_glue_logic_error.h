...
//
#ifndef _INCLUDED_TEST_GLUE_LOGIC_ERROR_H_
#define _INCLUDED_TEST_GLUE_LOGIC_ERROR_H_
...
#pragma hls_design interface
  void CCS_BLOCK(run)(ac_channel<int >      &rd_data0,
                      ...
                      bool                  rd_wr1,
                      bool                  priority0) {
    bool internal_priority;

    if (priority0 & !rd_wr0 & rd_wr1) {
      internal_priority = !priority0;
    } else {
      internal_priority = priority0;
    }
    ...
    mem_block.run(mem_rd_data0_chan,mem_rd_addr0_chan,mem_wr_addr_data0_chan,mem_rd_data1_chan,mem_rd_addr1_chan,mem_wr_addr_data1_chan,internal_priority);
  }
