#ifndef __INCLUDED_sram_8192_128_db_trans_rsc_H__
#define __INCLUDED_sram_8192_128_db_trans_rsc_H__
#include <mc_transactors.h>

class sram_8192_128_db_trans_rsc : public mc_wire_trans_rsc_base<128,8192>
{
public:
  sc_in< bool >   clk0;
  sc_in< sc_logic >   csb0;
  sc_in< sc_logic >   web0;
  sc_in< sc_lv<13> >   addr0;
  sc_in< sc_lv<128> >   din0;
  sc_in< bool >   clk1;
  sc_in< sc_logic >   csb1;
  sc_in< sc_lv<13> >   addr1;
  sc_out< sc_lv<128> >   dout1;

  typedef mc_wire_trans_rsc_base<128,8192> base;
  MC_EXPOSE_NAMES_OF_BASE(base);

  SC_HAS_PROCESS( sram_8192_128_db_trans_rsc );
  sram_8192_128_db_trans_rsc(const sc_module_name& name, bool phase, double clk_skew_delay=0.0)
  ...
  virtual void start_of_simulation() {
    ...
    if (base::_holdtime > 0) {
      ...
      msg << "sram_8192_128_db_trans_rsc CLASS_STARTUP - CLK_SKEW_DELAY = "
...
private:
  ...
  int get_addr(const sc_lv<13>& addr, const char* pin_name) {
    if (addr.is_01()) {
      const int cur_addr = addr.to_uint();
      if (cur_addr < 0 || cur_addr >= 8192) {
#ifdef CCS_SYSC_DEBUG
        std::ostringstream msg;
        msg << "Invalid address '" << cur_addr << "' out of range [0:" << 8192-1 << "]";
...
#endif // ifndef __INCLUDED_sram_8192_128_db_trans_rsc_H__
