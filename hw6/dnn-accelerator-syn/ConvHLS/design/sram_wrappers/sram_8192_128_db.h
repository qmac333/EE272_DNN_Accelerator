#ifndef __INCLUDED_sram_8192_128_db_H__
#define __INCLUDED_sram_8192_128_db_H__

// SystemC memory model of sram_8192_128_db
// Generated by Catapult memory generator
// Generated by:   jiajunc4
// Generated date: Mon Feb 17 18:53:14 2025

// The following classes have been defined:
//     class sram_8192_128_db a 0 delay "structural" model of the RAM

//     class sram_8192_128_db_model<TLM/SYN>::mem<T,size,TLM/SYN>
//         A memory model that can be instanced and used for simulation and synthesis

//     class sram_8192_128_db_model<TLM/SYN>::port_0_port<T,size,TLM/SYN>
//         a model of an external port with write capability

//     class sram_8192_128_db_model<TLM/SYN>::port_1_port<T,size,TLM/SYN>
...
#pragma map_to_operator sram_8192_128_db
template <
  int ram_id>
class sram_8192_128_db : public sc_module
{
public:
  sc_in< bool >   clk0;
  sc_in< bool >   csb0;
  ...
  sc_signal<sc_lv<128> > mem[8192];
#endif

  SC_CTOR(sram_8192_128_db) :
    clk0("clk0")
    ,csb0("csb0")
    ,web0("web0")
    ,addr0("addr0")
...
#endif // ifndef __INCLUDED_sram_8192_128_db_H__
