...
def test_ifmap_double_buffer_tb():
    ...
    return 1, run_process(['vcs', '-full64', '-sverilog', '-timescale=1ns/1ps', '-debug_access+pp', 'tests/ifmap_double_buffer_tb.v', 'rtl/double_buffer.v', 'rtl/ram_sync_1r1w.v'])

def test_weight_double_buffer_tb():
    print("Running test_weight_double_buffer_tb")
    return 1, run_process(['vcs', '-full64', '-sverilog', '-timescale=1ns/1ps', '-debug_access+pp', 'tests/weight_double_buffer_tb.v', 'rtl/double_buffer.v', 'rtl/ram_sync_1r1w.v'])
